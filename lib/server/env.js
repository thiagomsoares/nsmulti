// Arquivo env.js modificado para suportar o Nightscout Multi-Paciente
'use strict';
...
function updateSettings () {
  ...
  // Configuração específica para o Nightscout Multi-Paciente
  env.settings.enable_multi_patient = readENVTruthy('ENABLE_MULTI_PATIENT', false);
  env.settings.admin_token = readENV('ADMIN_TOKEN', '');
